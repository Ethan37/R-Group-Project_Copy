---
title: "Do Xbox and Playstation have different Global Sales"
...
BySystemPlot <- grid.arrange(p1,logp1, nrow=1)
XboxPlot <- grid.arrange(p2, logp2, nrow=1)
PlayStationPlot <- grid.arrange(p3, logp3, nrow=1)
```
```{r saveplots, include=FALSE}
ggsave("BySystemPlot.png")
ggsave("PlayStationPlot.png")
ggsave("XboxPlot.png")
```
...
The t-test was significant at an alpha=0.05 confidence level. There is a significant difference of the means of the global sales for xbox and playstation consoles. The mean global sales of the xbox console was significantly higher than the mean global sales of the playstation console.